...
import sentry_sdk
from api import auth, client, client_user, project, project_categories, project_collaborators, project_media_categories, project_media_sources, project_ml, project_report, project_report_avenues, project_report_consultations, project_report_times, project_thematic_areas
...
def custom_openapi():
    ...
    for path in openapi_schema["paths"]:
        for method in openapi_schema["paths"][path]:
            if path not in ["/api/api/hamasa-api/v1/auth/login", "/api/api/hamasa-api/v1/auth/refresh-token"]:  # Public endpoints
